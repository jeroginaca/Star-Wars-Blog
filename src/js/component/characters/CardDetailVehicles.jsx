  ...
  <div className="container">
        <div className="desc-lead d-flex text-start align-items-center" >
            ...
            <div className="desc-text">
                <h5 className="card-title"> {store.vehicle[id-1].name}</h5>
        ...
        <div className="red-desc d-flex justify-content-center text-center">
                <p className="card-text p-5 ">Gender: <br />{store.vehicle[id-1].gender}</p>
                <p className="card-text p-5 ">Birth Year: <br />{store.vehicle[id-1].birth_year}</p>
                <p className="card-text p-5 ">Hair Color: <br />{store.vehicle[id-1].hair_color}</p>
                <p className="card-text p-5 ">Eye-Color: <br />{store.vehicle[id-1].eye_color}</p>
        </div>
    </div> 
